 ...
 *
 * Each PNG is the supplied artwork with the artboard's own rotation baked in,
 * and its position was fitted against the design render rather than eyeballed.
 * The artwork is whole — props that the frame clips simply hang off the edge —
 * so they can drift and lean without ever showing a cut edge.
 */
export type PropSpec = {
  ...
  left: number;
  top: number;
  /** Fraction of screen width. Height follows from `aspect`. */
  width: number;
  aspect: number;
...
export const PROPS: PropSpec[] = [
  ...
  },
  {
    ...
    sway: { degrees: 3.0, duration: 8200, phase: 0.5 },
    order: 0,
  },
  {
    key: 'plane',
    ...
    sway: { degrees: 4.0, duration: 6800, phase: 0.2 },
    order: 2,
  },
  {
    key: 'ramen',
    ...
    sway: { degrees: 3.0, duration: 7800, phase: 0.75 },
    order: 4,
  },
  {
    key: 'ticket',
  ...
  },
  {
    ...
    sway: { degrees: 3.0, duration: 8600, phase: 0.1 },
    order: 6,
  },
  {
    key: 'goal',
  ...
  },
  {
    ...
    sway: { degrees: 6.0, duration: 5800, phase: 0.0 },
    order: 7,
  },
  {
    key: 'coffee',
  ...
  },
  {
    ...
    sway: { degrees: 2.0, duration: 8000, phase: 0.55 },
    order: 9,
  },
];
